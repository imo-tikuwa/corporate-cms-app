...
class ChargesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'プラン名', 'precision' => null],
        'annotation' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'プラン名下注釈', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-11-29 11:11:10',
                'modified' => '2020-11-29 11:11:10',
                'deleted' => null,
            ],
        ];
        parent::init();
