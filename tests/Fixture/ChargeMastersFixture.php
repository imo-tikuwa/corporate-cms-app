...
class ChargeMastersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'マスタ名', 'precision' => null],
        'basic_charge' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '基本料金', 'precision' => null, 'autoIncrement' => null],
        'campaign_charge' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => 'キャンペーン料金', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-11-29 11:11:05',
                'modified' => '2020-11-29 11:11:05',
                'deleted' => null,
            ],
        ];
        parent::init();
