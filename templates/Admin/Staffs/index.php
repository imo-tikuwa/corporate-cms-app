    ...
    <div class="card-header">
      <div class="form-inline">
        <div class="btn-group mr-2" role="group">
          ...
          <?php } ?>
          <a class="btn btn-flat btn-outline-secondary d-none d-md-inline" href="javascript:void(0);" data-toggle="modal" data-target="#staffs-search-form-modal">検索</a>
          ...
          <div class="dropdown-menu" aria-labelledby="sp-action-link">
            ...
            <?php } ?>
            <a class="dropdown-item" href="javascript:void(0);" data-toggle="modal" data-target="#staffs-search-form-modal">検索</a>
            <?php if (AuthUtils::hasRole($this->getRequest(), ['action' => ACTION_CSV_EXPORT])) { ?>
