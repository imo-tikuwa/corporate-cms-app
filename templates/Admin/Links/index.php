    ...
    <div class="card-header">
      <div class="form-inline">
        <div class="btn-group mr-2" role="group">
          ...
          <?php } ?>
          <a class="btn btn-flat btn-outline-secondary" href="javascript:void(0);" data-toggle="modal" data-target="#links-search-form-modal">検索</a>
          ...
          <?php if (AuthUtils::hasRole($this->getRequest(), ['action' => ACTION_CSV_IMPORT])) { ?>
            <a class="btn btn-flat btn-outline-secondary" href="javascript:void(0);" id="csv-import-btn">CSVインポート</a>
          ...
          <?php if (AuthUtils::hasRole($this->getRequest(), ['action' => ACTION_EXCEL_IMPORT])) { ?>
            <a class="btn btn-flat btn-outline-secondary" href="javascript:void(0);" id="excel-import-btn">Excelインポート</a>
