...
class AppView extends View
{
    ...
    /**
     * 画像ファイル名を元にサムネイル画像のファイル名を生成
     * @param string $image_name 画像ファイル名
     * @return string サムネイル画像のファイル名
     */
    public function thumbPath($image_name)
    {
        $thumb_name = pathinfo($image_name, PATHINFO_FILENAME) . '_thumb.' . pathinfo($image_name, PATHINFO_EXTENSION);
        return $thumb_name;
    }
}
